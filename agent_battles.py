import asyncio
from poke_env import RandomPlayer, ServerConfiguration
...
async def agent_battles():
    random_player = RandomPlayer(battle_format="gen8randombattle", server_configuration=LOCAL_SERVER)
    second_player = RandomPlayer(battle_format="gen8randombattle", server_configuration=LOCAL_SERVER)
